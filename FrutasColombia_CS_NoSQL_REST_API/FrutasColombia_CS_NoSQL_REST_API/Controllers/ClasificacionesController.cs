...
namespace FrutasColombia_CS_NoSQL_REST_API.Controllers
{
    ...
    public class ClasificacionesController(ClasificacionService clasificacionService) : Controller
    {
        ...
        {
            var lasTaxonomias = await _clasificacionService
                .GetAllAsync();

            return Ok(lasTaxonomias);
        }
        ...
        //[HttpGet("Generos/{genero_id:string?}")]
        //public async Task<IActionResult> GetGenusByIdAsync(string? genero_id)
        //{
        //    try
        //    {
        ...
        //[HttpGet("Generos/{genero_id:string?}/Frutas")]
        //public async Task<IActionResult> GetFruitsByGenusIdAsync(string? genero_id)
        //{
        //    try
        //    {
        //        var unGenero = await _clasificacionService
