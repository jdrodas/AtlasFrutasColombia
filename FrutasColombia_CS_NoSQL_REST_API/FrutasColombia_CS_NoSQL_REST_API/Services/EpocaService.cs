...
namespace FrutasColombia_CS_NoSQL_REST_API.Services
{
    ...
    //                                IFrutaRepository frutaRepository)
    {
        ...
        public async Task<Epoca> GetByIdAsync(string epoca_id)
        {
            ...
            if (string.IsNullOrEmpty(unaEpoca.Id))
        ...
        public async Task<Epoca> CreateAsync(Epoca unaEpoca)
        {
            ...
            if (!string.IsNullOrEmpty(epocaExistente.Id))
        ...
        public async Task<Epoca> UpdateAsync(Epoca unaEpoca)
        {
            ...
            if (!string.IsNullOrEmpty(epocaExistente.Id) && epocaExistente.Id != unaEpoca.Id)
        ...
        public async Task<string> RemoveAsync(string epoca_id)
        {
            ...
            string nombreEpocaEliminada = unaEpoca.Nombre!;
